    ...
    <FarmerLayout>
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            {!farmer ? (
              <p className="text-sm text-muted-foreground">No farm profile found.</p>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                ...
                <div>
                  ...
                  <p className="font-medium text-foreground">{farmer.verification_status}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="font-medium text-foreground">{farmer.address || "-"}</p>
                </div>

                <div className="md:col-span-2">
                  <p className="text-sm text-muted-foreground">Description</p>
                  <p className="font-medium text-foreground">{farmer.farm_description || "-"}</p>
                </div>

                <div className="md:col-span-2">
                  <p className="text-sm text-muted-foreground">Crops</p>
                  <p className="font-medium text-foreground">{farmer.crops?.length ? farmer.crops.join(", ") : "-"}</p>
                </div>

                <div>
                  <p className="text-sm text-muted-foreground">Total Sales</p>
                  <p className="font-medium text-foreground">{farmer.total_sales.toLocaleString()}</p>
                </div>

                <div>
                  <p className="text-sm text-muted-foreground">Total Earnings</p>
                  <p className="font-medium text-foreground">${farmer.total_earnings.toLocaleString()}</p>
                </div>
              </div>
            )}
          </CardContent>
